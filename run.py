...
cfg.train_batch_lengthmax = int(3.0/0.005) # Maximum duration [frames] of each batch # TODO TODO TODO was 2 prev good qual BLSTM train with 3.0 seems to influence a lot!
